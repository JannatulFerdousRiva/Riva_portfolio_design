...
<body class="bg-gray-100">
    ...
    <!-- Background Pattern -->
    <div class="fixed top-0 left-0 w-full h-full bg-gray-100 -z-10" style="background-image: radial-gradient(circle at 1px 1px, rgba(0,0,0,0.05) 1px, transparent 0); background-size: 40px 40px;"></div>
</body>
</html>